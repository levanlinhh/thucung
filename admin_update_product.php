...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$name', details = '$details', price = '$price' WHERE id = '$update_p_id'") or die('Thất bại');
...
?>
      ...
      echo '<p class="empty">Không thể cập nhật !</p>';
   }
?>
